...
pub fn tokenize(source: &str) -> Result<Vec<Token>, Vec<String>> {
    let mut lexer = LightLexer::new(source);
...
mod tests {
    ...
    #[test]
    fn test_keywords() {
        let tokens = tokenize("fn if else while for return let true false null and or not").unwrap();
        assert_eq!(
            kinds(&tokens),
            vec![
                TokenKind::Fn,
    ...
    fn test_punctuation() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                TokenKind::ColonEq, TokenKind::Eof,
            ]
        );
    }
    ...
    fn test_newlines_and_indent() {
        ...
        assert_eq!(
            kinds(&tokens),
            vec![
                TokenKind::Fn, TokenKind::Identifier, // fn foo
                TokenKind::Newline,
                TokenKind::Indent,
                TokenKind::Identifier, TokenKind::Eq, TokenKind::Integer, // x = 1
                TokenKind::Newline,
                TokenKind::Dedent,
                TokenKind::Eof,
            ]
    ...
    fn test_double_dedent() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                TokenKind::Newline,
                TokenKind::Indent,     // indent for b
                TokenKind::Identifier, // b
                TokenKind::Newline,
                TokenKind::Indent,     // indent for c
                TokenKind::Identifier, // c
                TokenKind::Newline,
                TokenKind::Dedent,     // dedent back to b's level
                TokenKind::Identifier, // d
                TokenKind::Newline,
                TokenKind::Dedent,     // dedent back to a's level
                TokenKind::Eof,
            ]
        );
    }
    ...
    fn test_locations() {
        ...
        assert_eq!(tokens[0].location.line, 1); // a
        ...
        assert_eq!(tokens[3].location.line, 2); // b
